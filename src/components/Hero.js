...
import bgpng from '../assets/cyber-bg.png';
const Hero = () => {
  return (
    <div className="w-full h-screen bg-zinc-200 flex flex-col justify-between">
      <div className="grid md:grid-cols-2 max-w-[1240px] m-auto">
        ...
        <div>
          <img src={bgpng} className="w-full" />
        </div>
        <div
          className="flex flex-col py-8 md:min-w-[760px] absolute bottom-[5%] mx-1 shadow-xl
          transform md:-translate-x-1/2 md:left-1/2 border bg-zinc-200 border-slate-300 text-center rounded-r-xl"
        >
